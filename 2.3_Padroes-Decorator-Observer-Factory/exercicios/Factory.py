...
# Interface Factory Method - Criador de objetos (Item)
class Combo(ABC):
    def __init__(self):
        self.items = []
        self.criar_combo()
...
# Criadoras concretas, que possuem a responsabilidade final de fabricar o
# objeto desejado e tudo que é necessário para ele:
# temos três Combos: ComboTudo, ComboFeliz e ComboGelado.
# Cada um é fabricado conforme é desejado pelo restaurante.
...
# Podemos apenas usar nossa fábrica e teremos um código simples e objetivo:
...
if __name__ == "__main__":
    ...
    # Para transformar uma string em código executável basta usar
    # o método eval()
